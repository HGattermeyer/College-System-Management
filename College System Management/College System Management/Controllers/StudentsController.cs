...
using College_System_Management.Models.ViewModels;
...
namespace CollegeSystemSystem.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public StudentsController(College_System_ManagementContext context, CourseService courseService, StudentService studentService, GradeService gradeService)
        {
            _context = context;
