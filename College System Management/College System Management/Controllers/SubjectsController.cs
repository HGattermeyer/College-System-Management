...
namespace CollegeSystemSystem.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(College_System_ManagementContext context, SubjectService subjectService, CourseService courseSubject, TeacherService teacherSubject)
        {
            _context = context;
