...
namespace CollegeSystemSystem.Controllers
{
    public class GradesController : Controller
    {
        ...
        public GradesController(College_System_ManagementContext context, StudentService studentService, SubjectService subjectService, TeacherService teacherService)
        {
            _context = context;
